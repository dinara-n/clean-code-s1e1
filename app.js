...
var createNewTaskElement=function(taskString){
    ...
    listItem.classList.add('incomplete-tasks__item', 'task-item');
    ...
    label.classList.add('task-item__label', 'task');

    //Each elements, needs appending
    checkBox.type="checkbox";
    editInput.type="text";
    editInput.classList.add('task-item__input', 'task');

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.classList.add('task-item__button', 'button', 'button_edit');

    deleteButton.classList.add('task-item__button', 'button', 'button_delete');
    deleteButtonImg.src='./remove.svg';
    deleteButton.appendChild(deleteButtonImg);

    deleteButtonImg.classList.add('button_delete__image');
